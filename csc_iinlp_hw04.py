    ...
    def fit(self, text_reader: Callable):
        ...
        for sentence in tqdm(text_reader(), "sentences", corpus_sent_size):
            ...
            for c in range(len(sentence)):
                ...
                # итерируемся в окне, заполняем счетчики, пропускаем редкие и популярные слова
        ...
        # считаем априорные вероятности для всех слов в словаре
        ...
        # считаем совместные вероятности слов и PMI матрицу
        ...
        # снижаем размерность матрицы с помощью SVD – получаем матрицу эмбеддингов размерности dict_size x 64
